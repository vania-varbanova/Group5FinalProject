...
public class DatabaseService {
    private final String DATABASE_URL = "jdbc:mysql://sql11.freemysqlhosting.net:3306/sql11650015";
    private final String USERNAME = "sql11650015";
    private final String PASSWORD = "AhM5MavKdT";
