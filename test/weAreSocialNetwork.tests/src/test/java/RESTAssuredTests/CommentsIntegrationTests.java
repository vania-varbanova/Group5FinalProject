...
public class CommentsIntegrationTests extends BaseIntegrationTest {
    ...
    public void commentSuccessfullyDisliked_when_sendRequestWithValidBody() throws SQLException {
        ...
        commentRequest.likeComment(commentResponseModel.getId(), cookie);
        CommentResponseModel updatedCommentModel = commentRequest.dislikeComment(commentResponseModel.getId(), cookie);
